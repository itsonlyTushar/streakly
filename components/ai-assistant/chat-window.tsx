    ...
    try {
      if (action.type === "add_dsa") {
        await addDSA.mutateAsync({
          ...
          actuallyAsking: action.actuallyAsking ?? null,
          pattern: action.pattern ?? null,
          keyObservation: action.keyObservation ?? null,
          maintainedState: action.maintainedState ?? null,
          whyItWorks: action.whyItWorks ?? null,
